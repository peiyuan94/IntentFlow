...
CIntentFlowDlg::CIntentFlowDlg(CWnd* pParent /*=nullptr*/)
...
// CIntentFlowDlg 消息处理程序

BOOL CIntentFlowDlg::OnInitDialog()
{
...
void CIntentFlowDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CIntentFlowDlg::OnQueryDragIcon()
{
